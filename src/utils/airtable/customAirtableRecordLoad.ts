import {RecordData,  Record as AirtableRecord, FieldSet as Field } from "airtable";


export type CellReader = {
	key: string;
	condition?: (ops: { record: typeof AirtableRecord; field: Field }) => boolean;
	read: (ops: {
		record: typeof AirtableRecord;
		field: Field;
		cellValue: unknown;
...
export interface CustomParser {
	format: string;
	conditionsMatch: (init: {
		record: typeof AirtableRecord;
		field: Field;
	}) => boolean;
	parse: (
		cellValueAsString: string,
		ops?: { record: typeof AirtableRecord; field: Field },
	) => unknown;
}
